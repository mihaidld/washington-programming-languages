...
i2 = Intersect.new(Point.new(2.5,1.5),
                   Intersect.new(LineSegment.new(2.0,1.0,3.0,2.0),
                                 Intersect.new(LineSegment.new(0.0,0.0,2.5,1.5),
                                               Line.new(1.0,-1.0)))) 
i3 = i2.preprocess_prog.eval_prog([])
if not ((i3.is_a? Point) and i3.x == 2.5 and i3.y == 1.5)
  puts i3
  puts "Intersect eval_prog should evaluate to Point.new(2.5,1.5)"
end
...
p = Point.new(5.0,7.0).intersect(LineSegment.new(-1.0,2.0,5.0,7.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == FIVE and p1.y == SEVEN)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(5.0,7.0)"
end

p = Point.new(5.0,5.0).intersect(LineSegment.new(-1.0,5.0,10.0,5.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == FIVE and p1.y == FIVE)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(5.0,5.0)"
end

#Point#intersectLineSegment
p = Point.new(5.0,7.0).intersectLineSegment(LineSegment.new(-1.0,2.0,5.0,7.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == FIVE and p1.y == SEVEN)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(5.0,7.0)"
...
# Point#intersectLineSegment
p = Point.new(5.0,5.0).intersectLineSegment(LineSegment.new(-1.0,5.0,10.0,5.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == FIVE and p1.y == FIVE)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(5.0,5.0)"
...
p = LineSegment.new(-1.0,2.0,5.0,7.0).intersect(Point.new(5.0,7.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == FIVE and p1.y == SEVEN)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(5.0,7.0)"
...
# Point#intersect
np = Point.new(5.0,5.0).intersect(LineSegment.new(1.0,1.0,5.0,6.0))
np1 = np.preprocess_prog.eval_prog([])
if not (np1.is_a? NoPoints)
  puts np1
  puts "Intersect eval_prog should evaluate to NoPoints"
end

# LineSegment#intersectPoint
np = LineSegment.new(1.0,1.0,5.0,6.0).intersectPoint(Point.new(5.0,5.0))
np1 = np.preprocess_prog.eval_prog([])
if not (np1.is_a? NoPoints)
  puts np1
  puts "Intersect eval_prog should evaluate to NoPoints"
...
# Line#intersect
np = Line.new(1.0,0.0).intersect(LineSegment.new(3.0,6.0,9.0,11.0))
np1 = np.preprocess_prog.eval_prog([])
if not (np1.is_a? NoPoints)
  puts np1
  puts "Intersect eval_prog should evaluate to NoPoints"
...
# Line#intersect
p = Line.new(5.0,0.0).intersect(LineSegment.new(1.0,5.0,2.0,2.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == ONE and p1.y == FIVE)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(1.0,5.0)"
end

# Line#intersect
p = Line.new(5.0,0.0).intersect(LineSegment.new(-1.0,-1.0,1.0,5.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == ONE and p1.y == FIVE)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(1.0,5.0)"
...
# LineSegment#intersectLine
np = LineSegment.new(3.0,6.0,9.0,11.0).intersectLine(Line.new(1.0,0.0))
np1 = np.preprocess_prog.eval_prog([])
if not (np1.is_a? NoPoints)
  puts np1
  puts "Intersect eval_prog should evaluate to NoPoints"
...
# LineSegment#intersectLine
p = LineSegment.new(1.0,5.0,2.0,2.0).intersectLine(Line.new(5.0,0.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == ONE and p1.y == FIVE)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(1.0,5.0)"
...
# LineSegment#intersectLine
p = LineSegment.new(-1.0,-1.0,1.0,5.0).intersectLine(Line.new(5.0,0.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == ONE and p1.y == FIVE)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(1.0,5.0)"
...
# VerticalLine#intersect
p = VerticalLine.new(2.0).intersect(LineSegment.new(-1.0,-1.0,3.0,3.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == TWO and p1.y == TWO)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(2.0,2.0)"
end

# VerticalLine#intersect
p = VerticalLine.new(3.0).intersect(LineSegment.new(-1.0,-1.0,3.0,3.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == THREE and p1.y == THREE)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(3.0,3.0)"
end

# VerticalLine#intersect)
p = VerticalLine.new(-1.0).intersect(LineSegment.new(-1.0,-1.0,3.0,3.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == -ONE and p1.y == -ONE)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(-1.0,-1.0)"
end

# VerticalLine#intersect)
np = VerticalLine.new(-5.0).intersect(LineSegment.new(-1.0,-1.0,3.0,3.0))
np1 = np.preprocess_prog.eval_prog([])
if not (np1.is_a? NoPoints)
  puts np1
  puts "Intersect eval_prog should evaluate to NoPoints"
...
# LineSegment#intersectVerticalLine
p = LineSegment.new(-1.0,-1.0,3.0,3.0).intersectVerticalLine(VerticalLine.new(2.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == TWO and p1.y == TWO)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(2.0,2.0)"
...
# LineSegment#intersectVerticalLine
p = LineSegment.new(-1.0,-1.0,3.0,3.0).intersectVerticalLine(VerticalLine.new(3.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == THREE and p1.y == THREE)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(3.0,3.0)"
...
# LineSegment#intersectVerticalLine
p = LineSegment.new(-1.0,-1.0,3.0,3.0).intersectVerticalLine(VerticalLine.new(-1.0))
p1 = p.preprocess_prog.eval_prog([])
if not ((p1.is_a? Point) and p1.x == -ONE and p1.y == -ONE)
  puts p1
  puts "Intersect eval_prog should evaluate to Point.new(-1.0,-1.0)"
...
# LineSegment#intersectVerticalLine
np = LineSegment.new(-1.0,-1.0,3.0,3.0).intersectVerticalLine(VerticalLine.new(-5.0))
np1 = np.preprocess_prog.eval_prog([])
if not (np1.is_a? NoPoints)
  puts np1
  puts "Intersect eval_prog should evaluate to NoPoints"
