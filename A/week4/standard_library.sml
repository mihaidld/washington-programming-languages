(* Use REPL to get ML Standard Library documentation:

Get function signature:
List.Map; -> val it = fn : ('a -> 'b) -> 'a list -> 'b list

Get all function signatures in a structure (module): the interface without
the description.
E.g. functions from structure List
- structure X = List;
